...
if __name__ == "__main__":
    ...
    print("Tolerancia: 10^-5 | Punto inicial: p0 = 2.0")
    steffensen(g_12b, 2.0, TOL, MAX_ITER, DEC)

    print("\n" + "-"*60)
    print("[Ejercicio 12d] f(x) = x - cos(x) = 0")
    print("Usando g(x) = cos(x)")
    print("Tolerancia: 10^-5 | Punto inicial: p0 = 1.0")
    steffensen(g_12d, 1.0, TOL, MAX_ITER, DEC)